...
public class MelodyUnit : Unit {
	...
	void Defend(Unit other, int damage, float defenseModifier) {
		...
		//damage_display.transform.localPosition = new Vector3((float)other.transform.position.x, (float)(other.transform.position.y + 2), (float)other.transform.position.z);
